...
import "./App.css";
import { getNextWindowPosition, setWindowPosition } from "./lib/window";
import { isScreenpipeRunning } from "./lib/screenpipe";
...
function App() {
  ...
  async function checkScreenpipe() {
    setScreenpipeRunning(await isScreenpipeRunning());
  }

  return (
    <main>
      <button onClick={moveWindow}>Move window</button>
      <button onClick={checkScreenpipe}>Check screenpipe</button>
